...
function index()
	...
	entry({"admin", "services", "shadowsocksr", "status"},form("shadowsocksr/status"),_("Status"), 30).leaf = true
	...
	entry({"admin", "services", "shadowsocksr", "custom"},form("shadowsocksr/gfwlist-custom"),_("Custom List"), 40).leaf = true
	entry({"admin", "services", "shadowsocksr", "ad"},form("shadowsocksr/ad-list"),_("AD List"), 50).leaf = true
